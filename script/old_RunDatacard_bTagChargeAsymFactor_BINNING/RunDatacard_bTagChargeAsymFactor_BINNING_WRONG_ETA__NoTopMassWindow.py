...
def RunYear(Ana,Year,suffix,cut,xname,StatOnly,PreCalcScalePDF,DoSimple,Rebinning,pseudo):
    ...
    if pseudo:
        dsuffix+="_Pesudo"
    datacarddir="datacards"+dsuffix+"/bTagChargeAsymFactor_BINNING_WRONG_ETA/"+Ana+"/"+suffix+"/"+xname
...
def RunWithCondor(Ana,Year,suffix,cut,xname,StatOnly,PreCalcScalePDF,DoSimple,pseudo):
    ...
    WORKDIR="WORKDIR/bTagChargeAsym_BINNING_WRONG_ETA/datacard"+statonly_suffix+scalepdf_precalc_suffix+pseudo_suffix+"/"+Ana+"/"+Year+"/"+suffix+"/"+cut+"/"+xname
...
if __name__ == '__main__':
    ...
    Ana="TTsemiLepBtagChargeAsymEfficiencyMeasurement_BINNING__WRONG"
