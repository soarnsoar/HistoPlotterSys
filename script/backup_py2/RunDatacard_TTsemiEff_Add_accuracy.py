...
def RunWithCondor(Ana,Year,suffix,cut,xname,StatOnly,PreCalcScalePDF,DoSimple):
    ...
    GIT_HistoPlotterSys=os.getenv("GIT_HistoPlotterSys")
    commandlist.append("python -u "+GIT_HistoPlotterSys+"/script/RunDatacard_TTsemiEff_Add_accuracy.py --condorsub --xname "+xname+" --year "+Year+" --cut "+cut+statonly_option+scalepdf_precalc_option+dosimple_option)
