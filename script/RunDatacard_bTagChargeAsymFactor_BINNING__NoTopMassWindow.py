...
def RunWithCondor(Ana,Year,suffix,cut,xname,StatOnly,PreCalcScalePDF,DoSimple,pseudo):
    ...
    WORKDIR="WORKDIR/bTagChargeAsym_BINNING/datacard"+statonly_suffix+scalepdf_precalc_suffix+pseudo_suffix+"/"+Ana+"/"+Year+"/"+suffix+"/"+cut+"/"+xname
...
if __name__ == '__main__':
    ...
    suffix="runSys__ApplyBtagSF__use_beff__"
