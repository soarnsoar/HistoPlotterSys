...
def RunYear(Ana,Year,suffix,cut,xname,StatOnly,PreCalcScalePDF,DoSimple,Rebinning,pseudo,OneBinFailRegion,IsTestJob=False):
    ...
    datacarddir="datacards"+dsuffix+"/TTsemiLepChargeScoreEfficiencyMeasurement_splitcharge_noetabin/"+Ana+"/"+suffix+"/"+xname
    ...
    procpath=GIT_HistoPlotterSys+"/config/ForDC/TTsemiLepChargeScoreEfficiencyMeasurement_splitcharge_noetabin/proc.py"
    if IsTestJob:
        procpath=GIT_HistoPlotterSys+"/config/ForDC/TTsemiLepChargeScoreEfficiencyMeasurement_splitcharge_noetabin/proc_test.py"
...
def RunWithCondor(Ana,Year,suffix,cut,xname,StatOnly,PreCalcScalePDF,DoSimple,pseudo,OneBinFailRegion):
    ...
    WORKDIR="WORKDIR/TTsemiLepChargeScoreEfficiencyMeasurement_splitcharge_noetabin/datacard"+statonly_suffix+scalepdf_precalc_suffix+pseudo_suffix+OneBinFailRegion_suffix+"/"+Ana+"/"+Year+"/"+suffix+"/"+cut+"/"+xname
...
def GetRebinning(year,cut,x,suffix):
    ...
    path=GIT_HistoPlotterSys+"/config/ForDC/TTsemiLepChargeScoreEfficiencyMeasurement_splitcharge_noetabin/RebinInfo/TTsemiLepChargeScoreEfficiencyMeasurement__"+year+"__"+suffix+".py"
...
if __name__ == '__main__':
    ...
    ##---
    parser = argparse.ArgumentParser(description='RunDatacard_TTsemiLepChargeScoreEfficiencyMeasurement_splitcharge_noetabin.py')
