[
    ...
    ("DYbminus",{
        "procs":[p+"_b" for p in ["DYJetsToEE_MiNNLO","DYJetsToMuMu_MiNNLO","DYJetsToTauTau_MiNNLO"]],
        "color":61,
        "name":"DY b^{-}",
        "IsSig":True,
    }),
    ...
    ("DYbplus",{
        "procs":[p+"_bbar" for p in ["DYJetsToEE_MiNNLO","DYJetsToMuMu_MiNNLO","DYJetsToTauTau_MiNNLO"]],
        "color":99,
        "name":"DY b^{+}",
        "IsSig":True,
    }),            
